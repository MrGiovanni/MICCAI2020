...
### General questions:
- Release code? When comparing with other work, what if their work implementation is not publicly available?
...
When training Models Genesis using L2 loss, would it be helpful to include an additional regularization term? This work simulate tumor on MR images. Can model performance in this simulation be clinically reliable towards real tumors?
